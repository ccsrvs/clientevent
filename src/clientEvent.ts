export enum ClientEventTypes {
  OPERATION_INVENTORY_BATCHES_SEARCH,
  OPERATION_INVENTORY_ITEMS_SEARCH,
  OPERATION_EXPLOITATION_BATCHES_SEARCH,
  EXPLOITATION_ITEMS_SEARCH,
  DISPATCH_DEVICE,
  DISPATCH_BATCH,
  DISPATCH_OPERATION,
  SET_SNACK_BAR_MSG,
  OTHER,
  BATCH_INVENTORY_TAB_SEARCH,
  CLOSE_DIALOG_POPUP,
}
